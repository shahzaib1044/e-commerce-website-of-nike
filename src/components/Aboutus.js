    ...
    <div className="about-us">
      ...
      <div className="content">
        ...
        <p className="description">
          At Nike, we believe in the power of sport to unleash human potential. We are a global leader in athletic
          footwear, apparel, equipment, and accessories, dedicated to inspiring and enabling athletes of all levels to
          reach their full potential.
        </p>
        <p className="description">
          Since our founding in 1964 by Bill Bowerman and Phil Knight, Nike has continuously pushed the boundaries of
          innovation, design, and performance. We strive to create products that not only enhance athletic performance
          but also reflect the dynamic spirit of sport.
        </p>
        <p className="description">
          Our mission goes beyond just creating exceptional products. We are committed to creating positive change in
          the world through sport. Nike actively supports and promotes diversity, inclusivity, and equality, both within
          our organization and throughout the communities we serve. We believe in the power of sport to break barriers,
          bridge divides, and bring people together.
        </p>
        <p className="description">
          With a diverse range of athletes, teams, and partnerships across various sports and disciplines, Nike remains
          at the forefront of athletic excellence. We collaborate with top athletes and harness their insights to inform
          our product development, ensuring that every Nike innovation is rooted in real-world performance needs.
        </p>
        <p className="description">
          Our commitment to sustainability is also a fundamental part of who we are. We strive to minimize our
          environmental impact and maximize positive social impact. Through innovative technologies and responsible
          practices, we are working towards a more sustainable future, aiming to protect the planet for generations to
          come.
        </p>
        <p className="description">
          Whether you're an elite athlete striving for greatness or someone who simply enjoys being active, Nike is here
          to support and inspire you. Our products are designed to empower you to unleash your potential and push the
          boundaries of what you thought was possible.
        </p>
        <p className="description">
          Join us in our mission to ignite the athlete in everyone. Together, we can redefine sport and create a better,
          more inclusive world through the power of sport.
        </p>
      </div>
    </div>
  );
